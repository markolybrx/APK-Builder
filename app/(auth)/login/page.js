      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl z-50">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-[#24292F] text-white hover:bg-[#24292F]/90 font-bold py-3 rounded-xl transition-all border border-slate-700"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-white text-slate-900 hover:bg-slate-100 font-bold py-3 rounded-xl transition-all"
          >
          ...
          >
            ...
            <span>Bypass Auth (Dev Only)</span>
          </button>
        </div>
